//
//  CamerasVideoStoragePremiumViewController.swift
//  i2app
//
...
class CamerasVideoStoragePremiumViewController: UIViewController {
...
extension CamerasVideoStoragePremiumViewController: CameraVideoStoragePresenterDelegate {
