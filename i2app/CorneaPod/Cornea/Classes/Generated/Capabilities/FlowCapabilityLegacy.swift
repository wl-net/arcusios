...
@objcMembers public class FlowCapabilityLegacy: NSObject, ArcusFlowCapability, ArcusPromiseConverter {
  ...
  public static func getFlow(_ model: DeviceModel) -> NSNumber? {
    guard let flow: Double = capability.getFlowFlow(model) else {
      return nil
    }
    return NSNumber(value: flow)
  }
